...
let checkTokenRead = (req, res, next) => {
...
let checkTokenWrite = (req, res, next) => {
  if (req.body.role !== "writer") {
    return res.json({
      success: false,
      message: "Not allowed role for write",
    });
  }
  // Extrae el token de la solicitud enviado a través de cualquiera de los dos headers especificados
  // Los headers son automáticamente convertidos a lowercase
...
module.exports = {
  checkTokenRead: checkTokenRead,
  checkTokenWrite: checkTokenWrite,
};
